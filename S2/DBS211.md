...
## Week10 Normalization

- What is normalization
  - Normalization is the process of eliminating dependencies to non-PK attributes fields. 
  - ALL attributes in an entity, MUST depend [solely], and [directly], on [only] the [entire] primary key.
- What is DBDL
  - Database Definition Language
  - Is nothing more thana style guide (standardized documentation) to writing the design schema process of a database.
- UNF
- 1NF
  - Put Foreign key go on many side
  - 
...
- A transitive dependency is where a non-PK field depends on another non-PK field.(typically in the same table)

- FK enforce the referential integrity of the data
